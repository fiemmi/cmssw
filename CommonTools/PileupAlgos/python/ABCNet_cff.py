...
abc = cms.EDProducer("ABCNetProducer",
                     ...
                     graph_path = cms.FileInPath("CommonTools/PileupAlgos/data/AttentionBasedPileupRejectionModel_Run2_KDTree_SWDMETPDGID_dyn0pad_10knn_onlyVBF_noNumHitsLay.pb"),
